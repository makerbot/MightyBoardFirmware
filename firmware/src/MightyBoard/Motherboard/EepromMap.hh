...
//$BEGIN_ENTRY
//$eeprom_map:pid_eeprom_offsets $ignore
...
//$BEGIN_ENTRY
//$type:B $ingnore $constraints:l,0,1
...
//$BEGIN_ENTRY
//$type:40B $ingnore $constraints:a
